...
export default function Home(): JSX.Element {
  ...
  return (
    <main className="flex h-full flex-col items-center justify-between p-10 bg-black">
        <div className="mx-auto w-full h-full max-w-lg rounded-lg bg-white p-1 pt-4 shadow-card dark:bg-light-dark xs:p-6 xs:pt-5">
          <header className="mb-5 min-h-[40px]  border-gray-200 pb-4 uppercase tracking-wider dark:border-gray-700 xs:mb-6 xs:pb-5 xs:tracking-wide">
            <h1 className="text-black">KRYPTOBAY</h1>
          </header>
          <div className="hero  flex justify-center">
            <img className="" src="/hero3.png" alt="" />
          </div>
          <div className="buYSell p-10">
            <div className="relative mb-6 text-sm uppercase sm:gap-8 sm:rounded-none" role="tablist" aria-orientation="horizontal">
              <div className="rounded-lg border text-gray-900 dark:text-slate-200 border-gray-200 dark:border-gray-700 dark:hover:border-gray-500 ">
                <button className="flex w-full items-center justify-between p-4 uppercase text-gray-400 dark:text-gray-300 sm:px-5 sm:py-3.5">
                ...
                <div className="absolute left-0 top-full z-10 mt-1 grid w-full gap-0.5 rounded-lg border border-gray-200 bg-white p-2 text-left shadow-large dark:border-gray-700 dark:bg-gray-800 xs:gap-1 invisible opacity-0"><div>
                  <button className="relative z-0 uppercase tracking-wider hover:text-gray-900 focus:outline-none dark:hover:text-white w-full p-2.5" id="headlessui-tabs-tab-:ra:" role="tab" type="button" aria-selected="false"  data-headlessui-state="" aria-controls="headlessui-tabs-panel-:r5:"><span className="flex w-full justify-between px-3 md:px-0">
                    Buy
                    </span></button></div>
                  <div>
                    <button className="relative z-0 uppercase tracking-wider hover:text-gray-900 focus:outline-none dark:hover:text-white w-full p-2.5" id="headlessui-tabs-tab-:rb:" role="tab" type="button" aria-selected="false"  data-headlessui-state="" aria-controls="headlessui-tabs-panel-:r7:"><span className="flex w-full justify-between px-3 md:px-0">
                      Sell
                      </span></button></div>
                      <div><button className="relative z-0 uppercase tracking-wider hover:text-gray-900 focus:outline-none dark:hover:text-white w-full p-2.5" id="headlessui-tabs-tab-:rc:" role="tab" type="button" aria-selected="false"  data-headlessui-state="" aria-controls="headlessui-tabs-panel-:r8:"><span className="flex w-full justify-between px-3 md:px-0">
                        Send</span></button></div>
                      <div><button className="relative z-0 uppercase tracking-wider focus:outline-none dark:hover:text-white font-medium text-white hover:text-white focus:text-white w-full p-2.5" id="headlessui-tabs-tab-:rd:" role="tab" type="button" aria-selected="true"  data-headlessui-state="selected" aria-controls="headlessui-tabs-panel-:r9:"><span className="flex w-full justify-between px-3 md:px-0">
                        Exchange</span>
                        <span className="absolute bottom-0 left-0 right-0 -z-[1] h-full w-full rounded-lg bg-brand shadow-button" style={{ transform: 'none', transformOrigin: '50% 50% 0px', opacity: 1 }}>
                </span>
                </button>
                </div>
                </div>
            ...
            <span className="my-6 block h-[1px] border-b border-dashed border-b-gray-400">
            </span>
